...
#Generates SPEI values for a probabilistic forecast (one month, 21 members). Consumes the fitting parameters generated by running SPEI_UnbiasedGrid on the historical gridded data. This allows this script to calculate only the outputs rather than having to fit the log-logistic functions.
