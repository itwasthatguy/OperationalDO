...
REM "C:/Program Files/R/R-4.0.2/bin/x64/Rscript" !MainDir!/Processes/FitBiasCorrectionMappings_3Week.R --args !StartDate! !EndDate! !MainDir!

REM Deletes hindcast data downloaded to fit the bias corrections

REM "C:/Program Files/R/R-4.0.2/bin/x64/Rscript" !MainDir!/Processes/HindCleaner.R --args !StartDate! !MainDir!
...
"C:/Program Files/R/R-4.0.2/bin/x64/Rscript" !MainDir!/Processes/TestingNewClassification.R --args !StartDate! !MainDir!
...
REM Delete the forecasts/indices generated by the last month's run

REM "C:/Program Files/R/R-4.0.2/bin/x64/Rscript" !MainDir!/Processes/DOCleaner.R --args !StartDate! !MainDir!
