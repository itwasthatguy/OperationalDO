...
Samp = sample(which(TrainMatChange1[,30] == 5), size = min(c(150, length(which(TrainMatChange1[,30] == 5)))))
...
SubSampleMat = rbind(SubSampleMat, TrainMatChange1[Samp,])
Samp = sample(which(TrainMatChange1[,30] == 3), size = min(c(2000, length(which(TrainMatChange1[,30] == 3)))))
SubSampleMat = rbind(SubSampleMat, TrainMatChange1[Samp,])
Samp = sample(which(TrainMatChange1[,30] == 2), size = min(c(4300, length(which(TrainMatChange1[,30] == 2)))))
SubSampleMat = rbind(SubSampleMat, TrainMatChange1[Samp,])
Samp = sample(which(TrainMatChange1[,30] == 1), size = min(c(30000, length(which(TrainMatChange1[,30] == 1)))))
SubSampleMat = rbind(SubSampleMat, TrainMatChange1[Samp,])
Samp = sample(which(TrainMatChange1[,30] == 0), size = min(c(30000, length(which(TrainMatChange1[,30] == 0)))))
SubSampleMat = rbind(SubSampleMat, TrainMatChange1[Samp,])

Samp = sample(which(TrainMatChangeNot1[,30] == 5), size = min(c(150, length(which(TrainMatChangeNot1[,30] == 5)))))
...
SubSampleMat = rbind(SubSampleMat, TrainMatChangeNot1[Samp,])
Samp = sample(which(TrainMatChangeNot1[,30] == 3), size = min(c(2000, length(which(TrainMatChangeNot1[,30] == 3)))))
SubSampleMat = rbind(SubSampleMat, TrainMatChangeNot1[Samp,])
Samp = sample(which(TrainMatChangeNot1[,30] == 2), size = min(c(4300, length(which(TrainMatChangeNot1[,30] == 2)))))
SubSampleMat = rbind(SubSampleMat, TrainMatChangeNot1[Samp,])
Samp = sample(which(TrainMatChangeNot1[,30] == 1), size = min(c(30000, length(which(TrainMatChangeNot1[,30] == 1)))))
SubSampleMat = rbind(SubSampleMat, TrainMatChangeNot1[Samp,])
...
XTrainSub = XTrain[,c(1,4:7,16:19,27)]
...
for(Mem in 1:21){
  ...
  XPredictSub = XPredict[,c(1,4:7,16:19,27)]
